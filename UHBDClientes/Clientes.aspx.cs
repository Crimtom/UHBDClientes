...
namespace UHCLIENTESWEB
{
    public partial class Clientes : System.Web.UI.Page
    {
        ...
        protected void Bactualizar_Click(object sender, EventArgs e)
        {
            ...
            int cedula;
            int.TryParse(tcedula.Text, out cedula);
            SqlCommand comando = new SqlCommand(" UPDATE CLIENTES SET ( nombre, telefono, fecha_nacimiento ) VALUES('" + tnombre.Text + "', '" + ttelefono.Text + "'," +
                " '" + tfecha.Text + "'  ) WHERE CEDULA = " + cedula + "", conexion);
            comando.ExecuteNonQuery();
            conexion.Close();
            tnombre.Text = "";
            tcedula.Text = "";
